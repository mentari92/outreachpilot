...
│   └── 04-epics-and-stories.md   ← Build order & story checklist
├── .env.example                  ← API key template
├── .env                          ← Create this yourself (fill in your keys)
...
- [x] **Story 5.1** — CSV Export (Download Results CSV)
...
- All settings read/write via chrome.storage.sync
...
> Note: API keys in Chrome Extension are stored in chrome.storage.sync
